// https://github.com/FL3NKEY/scroll-lock/blob/master/dist/scroll-lock.min.js
...
//     const old_bg_color = getComputedStyle(header, null)
//         .getPropertyValue("background-color");
//     hamburger.addEventListener('click', () => {
//         header.style.backgroundColor = "#ee140c";
//         setTimeout(() => {
//             header.style.backgroundColor = old_bg_color;
//         }, 100);
//     });
// })();
...
$id("close-mission-btn").style.display = "none"
let parentID = this.parentElement.id
$qs(parentID + ".hide").forEach((el) => {
el.style.display = "block";
});
})
})
$id("close-mission-btn")
